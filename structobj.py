# Copyrights 2024: Nuttachat Wisittipanit
...
class AssemblyAnnotation:
    def __init__(self, uberStrain, AssemblyBarcode, Serovar):
        self.uberStrain = uberStrain  # uberStrain
        self.AssemblyBarcode = AssemblyBarcode
        self.Serovar = Serovar
        # self.Country = None  # Country


class STAnnotation:
    def __init__(self, uberStrain, STIndex):
        self.uberStrain = uberStrain  # main name used for identification: same as AssemblyBarcode
        self.STIndex = STIndex


class SeroAnnotation:
    def __init__(self, uberStrain, serotype):
        self.uberStrain = uberStrain  # main name used for identification: same as AssemblyBarcode
        self.serotype = serotype


class AssemblyAnnXcel:
    def __init__(self, name):
        """
        AssemblyAnnXcel
        :param name:
        ...
        self.nodeC1 = None
        self.nodeC2 = None
        self.A_CRISPR1_L = None
        self.A_CRISPR2_L = None
        self.B_CRISPR1_L = None
        self.B_CRISPR2_L = None
